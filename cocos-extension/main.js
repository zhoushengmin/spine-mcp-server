...
const TOOL_LABELS = {
  ...
  spine_cut_parts: '散件切割',
  spine_assemble: 'AI 装配绑骨',
  spine_generate_animation: '多骨骼动作生成',
  spine_list_effects: '效果配方目录',
  spine_apply_effect: '一句话执行效果',
  spine_mirror_bones: '镜像对称骨骼',
  spine_mesh_wave: '网格波动特效',
  spine_import_skin: '新贴图换装',
  spine_pose_to_animation: '姿势→动画',
  spine_mirror_animation: '动作镜像',
  spine_mix_animations: '动作过渡',
  spine_check_project: '项目体检',
  spine_export_sheet: '精灵表导出',
  spine_pipeline: '一键成片',
